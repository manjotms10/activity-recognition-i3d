...
if __name__ == '__main__':
    ...
    # Model Parmeters
    parser.add_argument('--eval_type', type=str, default='joint',
    ...
    print(out_predictions.shape, np.argmax(out_predictions, 0), kinetics_classes[np.argmax(out_predictions, 0)])
